...
android {
    ...
    signingConfigs {
        create("release") {
            ...
            val propPath = if (isCI) {
                ...
                "${System.getenv("HOME")}/zyxn/key/sign.properties"
            }
    ...
    buildTypes {
        ...
        debug {
            ...
            resValue("string", "app_name", "Zyxn [D]")
        }
    }
...
dependencies {
    ...
    implementation(projects.zyxnApi)
