...
val LocalZyxnEditorColorScheme = compositionLocalOf<ZyxnEditorColorScheme> {
    error("No ZyxnEditorColorScheme provided")
}

@Composable
fun rememberEditorColorScheme(): ZyxnEditorColorScheme {
