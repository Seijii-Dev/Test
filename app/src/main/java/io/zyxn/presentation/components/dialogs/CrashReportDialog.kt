package io.zyxn.presentation.components.dialogs
        ...
        Surface(
            ...
            Column(
                ...
                Row(
                    ...
                    FilledTonalButton(
                        onClick = {
                            uriHandler.openUri("https://github.com/zyxn-dev/zyxn/issues")
                        },
                        modifier = Modifier
                            .weight(1f)
...
private fun copyToClipboard(context: Context, crash: CrashHandler.CrashData) {
    ...
    clipboard.setPrimaryClip(ClipData.newPlainText("Zyxn Crash Report", text))
}
