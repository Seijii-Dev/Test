package io.zyxn.presentation.components.slider
...
/**
 * Object to hold defaults used by [io.zyxn.presentation.components.slider.CustomSlider]
 */
@Stable
object CustomSliderDefaults {
     ...
     * [io.zyxn.presentation.components.slider.CustomSlider] in different states.
     */
    @Composable
    fun colors() = colors(
    ...
    /**
     * The Default thumb for [io.zyxn.presentation.components.slider.CustomSlider] and [CustomRangeSlider]
     *
    ...
    /**
     * The Default track for [io.zyxn.presentation.components.slider.CustomSlider]
     *
