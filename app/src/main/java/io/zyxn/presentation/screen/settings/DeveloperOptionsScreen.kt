...
import io.zyxn.api.platform.currentArchitecture
...
import io.zyxn.app.icons.FileDownload
import io.zyxn.app.icons.FileUpload
import io.zyxn.app.icons.Unarchive
import io.zyxn.data.preferences.SettingsRepository
import io.zyxn.data.preferences.settingsJson
import io.zyxn.presentation.components.dialogs.TerminalWipeConfirmationDialog
import io.zyxn.presentation.navigation.LocalNavigator
import io.zyxn.presentation.navigation.SettingsScreen
import io.zyxn.presentation.screen.settings.components.SettingsItem
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            developerOptionsList(
                ...
                onExportClick = { exportLauncher.launch("zyxn-settings.json") },
