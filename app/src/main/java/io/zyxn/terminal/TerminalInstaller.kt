...
import io.zyxn.data.file.archive.extractXzTar
import io.zyxn.api.data.fs.Paths
import io.zyxn.data.fs.downloadFile
import io.zyxn.api.platform.currentArchitecture
import io.zyxn.api.terminal.home
import io.zyxn.api.terminal.projects
import io.zyxn.api.terminal.rootFs
import io.zyxn.api.terminal.versionFile
...
class TerminalInstaller(private val context: Context) {
    ...
    suspend fun installLatest(progress: InstallProgressListener) {
        ...
        val assetName = "zyxn-bootstrap-${currentArchitecture()}.tar.xz"
        val downloadUrl = "https://github.com/zyxn-dev/zyxn-bootstrap/releases/download/$latestVersion/$assetName"
