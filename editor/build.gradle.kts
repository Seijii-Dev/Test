...
abstract class GenerateTreeSitterTask : DefaultTask() {
    ...
    fun execute() {
        ...
        val editorFolder = baseOutputDir.resolve("com/zyxn/editor")
        editorFolder.mkdirs()
        ...
        for (lang in modules) {
            ...
            val packageName = "io.zyxn.languages.$lang"
        ...
        outputFileTreeSitter.writeText(
            """
            |package io.zyxn.editor
            |
            |import android.content.Context
            |import io.zyxn.editor.treesitter.DynamicLanguageProvider
            |import io.zyxn.editor.treesitter.EditorLanguage
            |import io.zyxn.editor.treesitter.LanguageEntry
            |import io.zyxn.editor.treesitter.LanguagePriority
            |import io.zyxn.editor.treesitter.LanguageQueries
            |import io.zyxn.editor.treesitter.QuerySources
            |import io.zyxn.editor.treesitter.editorTheme
