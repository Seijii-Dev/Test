...
class I18nSymbolProcessorProvider : SymbolProcessorProvider {
    ...
    private companion object {
        const val ARG_PACKAGE_NAME = "zyxn.i18n.packageName"
        const val ARG_MODULE_NAME = "zyxn.i18n.moduleName"
        const val ARG_INTERNAL_VISIBILITY = "zyxn.i18n.internalVisibility"
        const val ARG_GENERATE_STRINGS_PROPERTY = "zyxn.i18n.generateStringsProperty"

        const val DEFAULT_PACKAGE_NAME = "io.zyxn.i18n"
    }
}
