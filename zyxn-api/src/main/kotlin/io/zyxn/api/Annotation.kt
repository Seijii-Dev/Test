...
/**
 * Marks declarations that are internal to the Zyxn ecosystem.
 *
...
@RequiresOptIn(
    ...
    message = "This is an internal Zyxn API that should not be used from outside of zyxn modules. " +
            "It may be changed or removed in the future without notice."
)
@MustBeDocumented
@Retention(AnnotationRetention.BINARY)
annotation class InternalZyxnApi
