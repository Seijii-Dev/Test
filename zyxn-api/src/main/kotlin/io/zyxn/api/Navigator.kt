...
/**
 * Handles navigation within the Zyxn application.
 *
...
interface Navigator : PluginService {
     ...
     * [ScreenRegistry][io.zyxn.api.ui.ScreenRegistry], this lets a plugin start a screen
     ...
     *
     * The screen is registered as a *transient* screen: zyxn auto-unregisters it when its
...
object SpecialScreens {
    /** The home screen ID. */
    val Home = ScreenId("<zyxn-home>")

    /** The settings screen ID. */
    val Settings = ScreenId("<zyxn-settings>")

    /** The terminal screen ID. */
    val Terminal = ScreenId("<zyxn-terminal>")
}
