...
/**
 * Utility for accessing standard Android application paths and Zyxn-specific directories.
 *
...
/**
 * The directory where installed Zyxn plugins are stored.
 */
val Paths.pluginsDir get() = dataDir.resolve("zyxn/plugins").also { it.createDirIfMissing() }
