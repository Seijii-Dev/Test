package io.zyxn.api.data.log

/**
 * Represents a single log event within the Zyxn ecosystem.
 *
 * `LogEntry` objects are created by the [io.zyxn.api.service.Logger] and are used
