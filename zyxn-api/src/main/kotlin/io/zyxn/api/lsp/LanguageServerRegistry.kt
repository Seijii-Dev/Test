...
interface LanguageServerRegistry : PluginService {
    ...
    /**
     * Internal method to register a [LanguageServerProvider] without a [ZyxnPlugin] context.
    ...
    /**
     * Returns every [RegisteredProvider] whose pattern matches [file]'s [KxFile.providerKey][io.zyxn.api.data.file.providerKey],
