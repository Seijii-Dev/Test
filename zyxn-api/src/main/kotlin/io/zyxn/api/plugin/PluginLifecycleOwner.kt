...
/**
 * A [LifecycleOwner] that manages the lifecycle of a [ZyxnPlugin].
 *
 * This interface bridges the Zyxn plugin system with Android's [Lifecycle] components,
 ...
 * ```
 *
 * Alternatively, from a [ZyxnPlugin] instance directly:
 *
 * ```kotlin
