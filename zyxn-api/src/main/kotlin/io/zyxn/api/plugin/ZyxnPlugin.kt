...
import io.zyxn.api.service.LogContext
import kotlinx.coroutines.CoroutineScope
import kotlinx.coroutines.currentCoroutineContext
import kotlin.coroutines.CoroutineContext

/**
 * The base interface for all Zyxn plugins.
 *
 * Plugins are the core components of the Zyxn system, allowing for modular functionality.
 *
 * ### Constructor contract
 * Plugin constructors must not access runtime services ([info], [pluginContext], [runtime]
 * delegates). These are provided by the zyxn only after construction and registration, so
...
interface ZyxnPlugin : LogContext {
