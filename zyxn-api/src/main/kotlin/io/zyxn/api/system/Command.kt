...
package io.zyxn.api.system

import android.annotation.SuppressLint
import io.zyxn.api.data.fs.Paths
import io.zyxn.api.terminal.home
import io.zyxn.api.terminal.processEnv
import io.zyxn.api.terminal.prootFile
 ...
 *
 * It automatically handles running binaries within the Zyxn PRoot environment if they
...
internal suspend fun resolveProgram(program: String): ResolvedProgram {
    ...
    // Actually, usually in Zyxn we want the terminal versions if they exist.
