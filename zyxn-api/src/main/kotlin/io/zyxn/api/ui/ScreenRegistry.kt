...
interface ScreenRegistry : PluginService {
     ...
     *
     * This method requires a [ZyxnPlugin] context to track which plugin registered the screen.
     */
     ...
     *
     * Transient screens are intended to be short-lived: zyxn auto-unregisters them when the
