...
import io.zyxn.api.util.extractMessage
...
class ToastHostState {
     ...
     *
     * **Recommendation for Plugins:** Use `ZyxnPlugin.showToast` instead. This method
     * will suspend the current execution context until the toast is finished. If you want
     * non-blocking behavior, wrap this call in a `scope.launch`, use `ZyxnPlugin.showToast`,
 ...
 *
 * **Recommendation for Plugins:** Use `ZyxnPlugin.showFailureToast` instead. This method
 * will suspend the current execution context until the toast is finished. If you want
 * non-blocking behavior, wrap this call in a `scope.launch`, use `ZyxnPlugin.showFailureToast`,
 * or proceed if suspending the current context is intended.
 */
