package io.zyxn.compiler.plugin.ir
...
class ZyxnIrGenerationExtension(
    ...
    override fun generate(moduleFragment: IrModuleFragment, pluginContext: IrPluginContext) {
        ...
        val pluginDescriptorClass = finder.findClass(ZyxnPluginIds.PLUGIN_DESCRIPTOR_CLASS_ID) ?: run {
            messageCollector.report(
                CompilerMessageSeverity.ERROR,
                "Zyxn compiler plugin: could not resolve PluginDescriptor. Is zyxn-api on the classpath?"
            )
            return
        }

        val transformers = listOf(ZyxnPluginManifestGenerator(pluginContext, pluginDescriptorClass))
        for (transformer in transformers) {
            moduleFragment.acceptChildrenVoid(transformer)
        }
    }

    private inner class ZyxnPluginManifestGenerator(
        ...
        override fun visitClass(declaration: IrClass) {
            if (declaration.hasAnnotation(ZyxnPluginIds.PLUGIN_MANIFEST_FQN)) {
        ...
        private fun fillDescriptor(
            ...
            val annotation = pluginClass.getAnnotation(ZyxnPluginIds.PLUGIN_MANIFEST_FQN) ?: return
            ...
            val descriptorProperty = companion.declarations
                ...
                .firstOrNull { it.name == ZyxnPluginIds.DESCRIPTOR_PROPERTY_NAME }
                ?: return
        ...
        private fun writeDescriptorJson(
            ...
            messageCollector.report(
                ...
                "Zyxn compiler plugin: wrote generated plugin.json for '$id'"
            )
        }
        ...
        private fun buildPluginAuthorCall(
            ...
            val authorClass = finder.findClass(ZyxnPluginIds.PLUGIN_AUTHOR_CLASS_ID)
        ...
        private fun buildPluginLinksCall(
            ...
            val linksClass = finder.findClass(ZyxnPluginIds.PLUGIN_LINKS_CLASS_ID)
