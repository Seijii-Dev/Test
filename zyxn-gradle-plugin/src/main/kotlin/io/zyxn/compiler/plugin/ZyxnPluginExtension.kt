...
abstract class ZyxnPluginExtension @Inject constructor(private val project: Project) {
    ...
    /** Target folder for built bundles. Defaults to 'build/zyxn/' */
    abstract val outputDirectory: DirectoryProperty

    /** Whether to automatically push the bundle to device's zyxn/plugins directory using adb */
